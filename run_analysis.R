...
Training.Set <- read.table("Downloads/UCI HAR Dataset/train/X_train.txt")
Training.Activity <- read.table("Downloads/UCI HAR Dataset/train/Y_train.txt")
Training.Subjects <- read.table("Downloads/UCI HAR Dataset/train/subject_train.txt", stringsAsFactors=FALSE)
Test.Set <- read.table("Downloads/UCI HAR Dataset/test/X_test.txt")
Test.Activity <- read.table("Downloads/UCI HAR Dataset/test/Y_test.txt")
Test.Subjects <- read.table("Downloads/UCI HAR Dataset/test/subject_test.txt", stringsAsFactors=FALSE)
Variables <- read.table("Downloads/UCI HAR Dataset/features.txt")
